...
export default function Intro() {
  return (<>
      ...
      <h3 className={"md:text-2xl text-neutral-600"}>Senior Front-end Developer</h3>
      <p className="text-sm text-neutral-400 mt-2">React · TypeScript · Next.js · Design Systems</p>
    </>)
}
